...
for {set i 1 } {$i < 100 } { incr i } {
	set destX [expr $destX + 7.0]
	set destY [expr $destY + 8.0]
	set times [expr $times + 0.1]
	$ns at $times "$n(0) setdest $destX $destY 3000.0" 
}
...
set times 0.1
for {set i 1 } {$i < 100 } {incr i} {
	set destX [expr $destX + 4.0]
	set destY [expr $destY + 6.0]
	set times [expr $times + 0.1]
	$ns at $times "$n(1) setdest $destX $destY 3000.0" 
}
...
set times 0.1
for {set i 1 } {$i < 100 } {incr i} {
	set destX [expr $destX + 5.0]
	set destY [expr $destY + 6.0]
	set times [expr $times + 0.1]
	$ns at $times "$n(2) setdest $destX $destY 3000.0" 
}
...
for {set i 1 } {$i < 100 } {incr i} {
	set destX [expr $destX + 5.0]
	set destY [expr $destY + 4.0]
	set times [expr $times + 0.1]
	$ns at $times "$n(3) setdest $destX $destY 3000.0" 
}
...
set times 0.1
for {set i 1 } {$i < 100 } {incr i} {
	set destX [expr $destX - 2.0]
	set destY [expr $destY + 3.0]
	set times [expr $times + 0.1]
	$ns at $times "$n(4) setdest $destX $destY 3000.0" 
}
...
set times 0.1
for {set i 1 } {$i < 100 } {incr i} {
	set destX [expr $destX - 1.0]
	set destY [expr $destY + 2.0]
	set times [expr $times + 0.1]
	$ns at $times "$n(5) setdest $destX $destY 3000.0" 
}
